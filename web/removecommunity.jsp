<%-- 
    Document   : removecommunity
    Created on : Jan 5, 2019, 3:27:42 PM
    Author     : shobhit
--%>
...
<html>
    ...
    <body>
        ...
        <div class ="left">
            ...
            <form method="post" action="removeCommunityServlet">    
        <div class = "right">
            <div class ="grid">
                <div class="set"><strong>Select Community to Remove</strong></div><br>
                <%
                    try{
                ...
                <ol class="list">  
                    <div class="comm"><br>
                            ...
                            <input type="checkbox" name="community" value="<%=rs.getString(1) %>"><strong>Remove</strong>
                        </div>
                        <%  if(rs.next()){%>
                        <div class="comm1"><br>
                             &nbsp;&nbsp;<span>Community Name: <strong><%= rs.getString(1) %></strong></span><br><br>
